-- ============================================================================
-- COMPLETE DATABASE MIGRATION FOR TEAM COLLABORATION
-- Copy and paste this ENTIRE file into Neon SQL Editor and click RUN
...
-- ============================================================================
-- VERIFICATION - This will show success message
-- ============================================================================
...
SELECT
    ...
    (SELECT COUNT(*) FROM "Project" WHERE "openForCollaboration" = true) as open_projects;
